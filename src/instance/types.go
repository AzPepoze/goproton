...
// LaunchOptions contains all game launch configuration options
type LaunchOptions struct {
	GamePath        string `json:"GamePath"`
	LauncherPath    string `json:"LauncherPath"`
	UseGameExe      bool   `json:"UseGameExe"`
...
// LsfgProfile represents saved LSFG profile settings for a game
