...
export namespace launcher {
	...
	export class LaunchOptions {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.LsfgGpu = source["LsfgGpu"];
	        this.LsfgFlowScale = source["LsfgFlowScale"];
	        this.LsfgPacing = source["LsfgPacing"];
	        this.LsfgAllowFp16 = source["LsfgAllowFp16"];
...
export namespace main {
	...
	export class GameInfo {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.config = this.convertValues(source["config"], launcher.LaunchOptions);
	        this.isRecent = source["isRecent"];
	    }
	...
	export class LsfgProfileData {
	    ...
	    static createFrom(source: any = {}) {
	        return new LsfgProfileData(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.gpu = source["gpu"];
	        this.flowScale = source["flowScale"];
	        this.pacing = source["pacing"];
	        this.dllPath = source["dllPath"];
	        this.allowFp16 = source["allowFp16"];
	    }
	}
	export class RunningSession {
	    ...
	    static createFrom(source: any = {}) {
	        return new RunningSession(source);
	    }
